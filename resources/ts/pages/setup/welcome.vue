    ...
    <div class="w-full md:w-3/5 lg:w-3/5 self-center">
        <div class="bg-white rounded shadow my-2 overflow-hidden">
            <div class="welcome-box border-b border-gray-300 p-3 text-gray-700">
                <p class="text-gray-600 text-sm">{{ __( 'Thank you for using MetisPOS to manage your store. This installation wizard will help you running MetisPOS in no time.' ) }}</p>
                <br>
    ...
    data() {
        return {
            field: {
                ...
                description: __( 'Select what will be the default language of MetisPOS.' ),
                name: 'language',
