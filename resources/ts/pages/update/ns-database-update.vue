    ...
    <div class="container mx-auto flex-auto items-center justify-center flex">
        <div id="database-update" class="w-full md:w-2/3 lg:w-1/3">
            <div class="flex justify-center items-center py-6">
                <img class="w-32" src="/svg/metis-pos-logo.svg" alt="MetisPOS">
            </div>
            <div class="my-3 rounded shadow ns-box">
                ...
                <div class="p-2 ns-box-body">
                    <p class="text-center text-sm py-4">{{ __( 'In order to keep MetisPOS running smoothly with updates, we need to proceed to the database migration. In fact you don\'t need to do any action, just wait until the process is done and you\'ll be redirected.' ) }}</p>
