        ...
        <div class="w-full md:w-1/2 xl:1/3 flex items-center flex-col justify-center">
            ...
            <div class="my-2 shadow overflow-hidden rounded bg-white w-95vw md:w-3/4 lg:w-3/5">
                ...
                <div class="p-4 text-gray-600 text-center text-sm">
                    {{ __( 'MetisPOS wasn\'t able to perform a database request. This error might be related to a misconfiguration on your .env file. The following guide might be useful to help you solving this issue.' ) }}
                </div>
                <ul class="flex flex-col">
                    <li class="flex">
                        <a target="_blank" href="https://docs.metis-pos.com/en/documentation/how-tos/how-to-change-database-configuration" class="border-t w-full border-gray-300 text-gray-600 text-sm p-2">
                            <i class="las la-hand-point-right"></i>
                            <span class="ml-2">{{ __( 'How to change database configuration' ) }}</span>
                        </a>
                    </li>
                    <li class="flex">
                        <a target="_blank" href="https://docs.metis-pos.com/en/documentation/troubleshooting/common-database-issues" class="border-t w-full border-gray-300 text-gray-600 text-sm p-2">
                            <i class="las la-hand-point-right"></i>
